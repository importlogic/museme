...
const Post = (props: propsInterface) => {
    return (
        <>
            <Modal id={`comment_${props.postDetails.key}`}>
                {props.postDetails.text}
            </Modal>

            <Container className='border-gray border-b-2 dark:border-gray-600'>
                    ...
                    <Container className='flex justify-evenly text-gray-400'>
                        ...
                        <Container
                            onClick={() => {
                                ...
                                if (myModal != null && myModal instanceof HTMLDialogElement) {
                                    myModal.showModal();
                                }
                            }}
