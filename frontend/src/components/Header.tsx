                ...
                <div className='grid grid-cols-3'>
                    ...
                    <div className='flex rounded-lg bg-[#f4f5fa] dark:bg-[#3b3b3b]'>
                        ...
                        <input
                            type='text'
                            placeholder='Search'
                            className='w-full rounded-lg bg-[#f4f5fa] p-2 outline-none dark:bg-[#3b3b3b]'
                            onInput={searchBarInputHandler}
                            ref={searchBar}
                        ></input>
                        {searchBarEmpty == 0 && (
                            <ClearIcon
                                className='m-2 rounded-full bg-white p-1 dark:text-black'
                                onClick={clearSearchBarHandler}
                            ></ClearIcon>
                        )}
                    </div>
                    <div className='flex flex-row-reverse'>
                        <button className='ml-2 rounded-xl bg-blue-600 p-2 px-3 font-medium text-white outline-none'>
                            Create Something
                        </button>
                        <ul className='flex'>
                            {[
